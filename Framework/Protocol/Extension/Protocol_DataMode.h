...
static inline Protocol_DataModeState_T * Protocol_DataMode_StateOf(Packet_Xfer_T * p_xfer) { return (Protocol_DataModeState_T *)p_xfer->p_Substate; }
...
static inline void Protocol_DataMode_Begin(Protocol_DataModeState_T * p_state, const Packet_Meta_T * p_rxMeta, const Protocol_DataMode_Req_T * p_req)
{
...
static inline size_t Protocol_DataMode_RemainingOf(const Protocol_DataModeState_T * p_state) { return p_state->Size - p_state->Count; }
...
*/
static inline Protocol_ReqCode_T Protocol_DataMode_Reply(const Protocol_DataModeState_T * p_state, Packet_Xfer_T * p_xfer, Protocol_DataMode_Resp_T * p_resp, uint16_t status, Protocol_ReqCode_T onOk)
{
...
static inline uint16_t Protocol_DataMode_WriteChunk(Protocol_DataModeInterface_T * p_app, Protocol_DataModeState_T * p_state, const Packet_Meta_T * p_rxMeta, const void * p_chunk)
{
...
static inline uint16_t Protocol_DataMode_ReadChunk(Protocol_DataModeInterface_T * p_app, Protocol_DataModeState_T * p_state, Packet_Xfer_T * p_xfer, void * p_chunk)
{
    packet_size_t chunk = Protocol_DataMode_ChunkOf(p_app, p_state);
...
static inline Protocol_DataModeStateId_T Protocol_DataMode_OpenStateOf(const Packet_Xfer_T * p_xfer)
{
...
*/
static inline Protocol_DataModeStateId_T Protocol_DataModeRead_StateOf(Protocol_DataModeInterface_T * p_app, const Protocol_DataModeState_T * p_state, const Packet_Xfer_T * p_xfer)
{
    if (p_xfer->p_RxMeta->Id == p_app->READ_ID) { return Protocol_DataMode_OpenStateOf(p_xfer); }
...
{
    if (p_xfer->p_RxMeta->Id == p_app->WRITE_ID) { return Protocol_DataMode_OpenStateOf(p_xfer); }
    ...
    if ((size_t)p_xfer->p_RxMeta->Length > Protocol_DataMode_RemainingOf(p_state)) { return PROTOCOL_DATA_MODE_STATE_ERROR; }

    return ((p_state->Count + p_xfer->p_RxMeta->Length) < p_state->Size) ? PROTOCOL_DATA_MODE_STATE_DATA : PROTOCOL_DATA_MODE_STATE_CLOSE;
}
...
*/
static inline Protocol_ReqCode_T Protocol_DataMode_Open(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const Protocol_DataMode_Req_T * p_req, Protocol_DataMode_Resp_T * p_resp)
{
    Protocol_DataModeState_T * p_state = Protocol_DataMode_StateOf(p_xfer);
    ...
    return Protocol_DataMode_Reply(p_state, p_xfer, p_resp, p_state->Status,
                                   (p_state->Size == 0U) ? PROTOCOL_REQ_DONE : PROTOCOL_REQ_RESPOND);
}
...
*/
static inline Protocol_ReqCode_T Protocol_DataMode_ReadData(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const void * p_rxPayload, uint8_t * p_chunk)
{
    Protocol_DataModeState_T * p_state = Protocol_DataMode_StateOf(p_xfer);
    (void)p_rxPayload;   /* the pacing ack carries nothing */

    return (Protocol_DataMode_ReadChunk(p_app, p_state, p_xfer, p_chunk) == PROTOCOL_DATA_MODE_STATUS_OK)
...
static inline Protocol_ReqCode_T Protocol_DataMode_ReadClose(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const void * p_rxPayload, Protocol_DataMode_Resp_T * p_resp)
{
    (void)p_app; (void)p_rxPayload;

    return Protocol_DataMode_Reply(Protocol_DataMode_StateOf(p_xfer), p_xfer, p_resp, PROTOCOL_DATA_MODE_STATUS_OK, PROTOCOL_REQ_DONE);
}
...
*/
static inline Protocol_ReqCode_T Protocol_DataMode_WriteData(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const uint8_t * p_chunk, Protocol_DataMode_Resp_T * p_resp)
{
    Protocol_DataModeState_T * p_state = Protocol_DataMode_StateOf(p_xfer);
...
static inline Protocol_ReqCode_T Protocol_DataMode_WriteClose(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const uint8_t * p_chunk, Protocol_DataMode_Resp_T * p_resp)
{
    Protocol_DataModeState_T * p_state = Protocol_DataMode_StateOf(p_xfer);
...
static inline Protocol_ReqCode_T Protocol_DataMode_Malformed(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const void * p_rxPayload, Protocol_DataMode_Resp_T * p_resp)
{
    (void)p_app; (void)p_rxPayload;

    return Protocol_DataMode_Reply(Protocol_DataMode_StateOf(p_xfer), p_xfer, p_resp, PROTOCOL_DATA_MODE_STATUS_MALFORMED, PROTOCOL_REQ_DONE);
}

/*! A chunk past the size the opening request declared. */
static inline Protocol_ReqCode_T Protocol_DataMode_Overrun(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const void * p_rxPayload, Protocol_DataMode_Resp_T * p_resp)
{
    (void)p_app; (void)p_rxPayload;

    return Protocol_DataMode_Reply(Protocol_DataMode_StateOf(p_xfer), p_xfer, p_resp, PROTOCOL_DATA_MODE_STATUS_OVERRUN, PROTOCOL_REQ_DONE);
}

/*! Nothing to absorb and nothing owed - the exchange stays open. */
static inline Protocol_ReqCode_T Protocol_DataMode_Idle(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const void * p_rxPayload, void * p_txPayload)
{
...
*/
static inline Protocol_ReqCode_T Protocol_DataMode_Read(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const void * restrict p_rxPayload, void * restrict p_txPayload)
{
    Protocol_DataModeState_T * p_state = Protocol_DataMode_StateOf(p_xfer);

    p_state->StateId = Protocol_DataModeRead_StateOf(p_app, p_state, p_xfer);
...
*/
static inline Protocol_ReqCode_T Protocol_DataMode_Write(Protocol_DataModeInterface_T * p_app, Packet_Xfer_T * p_xfer, const void * restrict p_rxPayload, void * restrict p_txPayload)
{
    Protocol_DataModeState_T * p_state = Protocol_DataMode_StateOf(p_xfer);
