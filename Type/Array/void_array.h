...
static inline int void_as_value(const void * p_unit, size_t type_size)
{
    int value = 0;
    switch (type_size)
    {
...
static inline int void_array_min_value(const void * p_buffer, size_t type_size, size_t length)
{
    return void_as_value(void_array_min(p_buffer, type_size, length), type_size);
}

static inline int void_array_max_value(const void * p_buffer, size_t type_size, size_t length)
{
