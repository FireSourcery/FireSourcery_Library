...
//{
//	const Analog_ConversionVirtualMap_T * p_map 		= &p_conversion->MAP;
...
////			else
//			{
//				if (_Analog_GetIsActive(p_analogI) == false) //check q empty is not checked at end of conversion ((Queue_GetIsEmpty(&p_analog->ConversionQueue) == false) && (_Analog_ReadIsActive(p_analog) == false))
//				{
//					p_analogI->p_ActiveConversion = p_conversion;
//					_Analog_ActivateConversion(p_analogI, p_adcConversion, p_map);
//					debug = 0;
