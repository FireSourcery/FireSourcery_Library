...
{
	return ((Flash_SetOp(p_flash, p_destFlash, p_source, size, opId) == FLASH_STATUS_SUCCESS) ? NvMemory_ProcOp_Blocking(p_flash) : FLASH_STATUS_ERROR_INPUT);
}

// proc last set
// Flash_Status_T Flash_ProcOp_Blocking(Flash_T * p_flash)
// {
