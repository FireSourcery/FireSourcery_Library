...
// typedef NvMemory_Status_T(*HAL_NvMemory_MapStatus_T)(NvMemory_T * p_hal); // or nvm
...
/*
    Blocking
*/
// extern NvMemory_Status_T NvMemory_ProcOp_Blocking(NvMemory_T * p_context) CONFIG_NV_MEMORY_ATTRIBUTE_RAM_SECTION;
