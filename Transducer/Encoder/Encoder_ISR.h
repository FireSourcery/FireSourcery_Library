...
{
	Encoder_ProcCaptureModeFunction(p_encoder, _Encoder_CaptureCounterD_Quadrature, _Encoder_CaptureCounterD_Inc);
}
...
*/
static void Encoder_CapturePulse(Encoder_T * p_encoder)
{
