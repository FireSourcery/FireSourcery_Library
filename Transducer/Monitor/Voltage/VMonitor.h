...
extern void VMonitor_InitFrom(const VMonitor_T * p_context, const VMonitor_Config_T * p_config);
extern void VMonitor_Init(const VMonitor_T * p_context);