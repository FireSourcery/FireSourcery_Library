...
int16_t Thermistor_GetShutdown_DegC(Thermistor_T * p_therm) 			{ return ConvertAdcuToDegC(p_therm, p_therm->Params.Fault_Adcu); }
int16_t Thermistor_GetShutdownThreshold_DegC(Thermistor_T * p_therm) 	{ return ConvertAdcuToDegC(p_therm, p_therm->Params.FaultThreshold_Adcu); }
...
int32_t Thermistor_GetShutdown_DegCInt(Thermistor_T * p_therm, uint16_t scalar) 			{ return Thermistor_ConvertToDegC_Int(p_therm, p_therm->Params.Fault_Adcu, scalar); }
int32_t Thermistor_GetShutdownThreshold_DegCInt(Thermistor_T * p_therm, uint16_t scalar) 	{ return Thermistor_ConvertToDegC_Int(p_therm, p_therm->Params.FaultThreshold_Adcu, scalar); }
...
float Thermistor_GetShutdown_DegCFloat(Thermistor_T * p_therm) 				{ return Thermistor_ConvertToDegC_Float(p_therm, p_therm->Params.Fault_Adcu); }
float Thermistor_GetShutdownThreshold_DegCFloat(Thermistor_T * p_therm) 	{ return Thermistor_ConvertToDegC_Float(p_therm, p_therm->Params.FaultThreshold_Adcu); }
