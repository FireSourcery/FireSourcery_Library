...
{
	MCSM_INPUT_FAULT,
	MCSM_INPUT_DIRECTION, /* Edge */
	MCSM_INPUT_THROTTLE, //PRCO THROTTLE
	MCSM_INPUT_BRAKE,
	//	MCSM_INPUT_FLOAT,
	MCSM_INPUT_RELEASE_THROTTLE, 	/* Release Control */
	MCSM_INPUT_RELEASE_BRAKE, 		/* Release Control */
	MCSM_INPUT_ZERO,				/* Zero Throttle/Brake Input */
	MCSM_INPUT_NEUTRAL,
	MCSM_INPUT_SET_NEUTRAL,
	// MCSM_INPUT_READY, transition init to stop, alternatively, check in init state through input type
