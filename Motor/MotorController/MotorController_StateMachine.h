...
static inline bool MotorController_StateMachine_IsPark(MotorController_T * p_context)   { return MotorController_StateMachine_IsState(p_context, MCSM_STATE_ID_PARK); }
static inline bool MotorController_StateMachine_IsFault(MotorController_T * p_context)  { return MotorController_StateMachine_IsState(p_context, MCSM_STATE_ID_FAULT); }
static inline bool MotorController_StateMachine_IsLock(MotorController_T * p_context)   { return MotorController_StateMachine_IsState(p_context, MCSM_STATE_ID_LOCK); }
...
// static inline bool MotorController_StateMachine_IsActive(MotorController_T * p_context, State_T * p_state) { return StateMachine_IsActivePathState(p_context->STATE_MACHINE.P_ACTIVE, & ); }
