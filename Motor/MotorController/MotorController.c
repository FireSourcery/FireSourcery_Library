...
*/
/******************************************************************************/
void MotorController_ForEachMotor(MotorController_T * p_mc, Motor_ProcVoid_T function) { return void_array_foreach(p_mc->CONST.P_MOTORS, sizeof(Motor_T), p_mc->CONST.MOTOR_COUNT, (proc_t)function); }
bool MotorController_IsEveryMotor(const MotorController_T * p_mc, Motor_Test_T test) { return void_array_is_every(p_mc->CONST.P_MOTORS, sizeof(Motor_T), p_mc->CONST.MOTOR_COUNT, (test_t)test); }
bool MotorController_IsAnyMotor(const MotorController_T * p_mc, Motor_Test_T test) { return void_array_is_any(p_mc->CONST.P_MOTORS, sizeof(Motor_T), p_mc->CONST.MOTOR_COUNT, (test_t)test); }
bool MotorController_IsEveryMotorValue(const MotorController_T * p_mc, Motor_TestValue_T test, register_t value) { return void_array_for_every_try(p_mc->CONST.P_MOTORS, sizeof(Motor_T), p_mc->CONST.MOTOR_COUNT, (try_t)test, value); }
...
void MotorController_StartThrottleMode(MotorController_T * p_mc)
{
    ...
    {
        case MOTOR_CONTROLLER_THROTTLE_MODE_SPEED:  MotorController_ForEachMotor(p_mc, Motor_User_StartSpeedMode);     break;
        case MOTOR_CONTROLLER_THROTTLE_MODE_TORQUE: MotorController_ForEachMotor(p_mc, Motor_User_StartTorqueMode);    break;
        default: break;
    }
}
...
void MotorController_StartBrakeMode(MotorController_T * p_mc)
{
    ...
    {
        case MOTOR_CONTROLLER_BRAKE_MODE_TORQUE:  MotorController_ForEachMotor(p_mc, Motor_User_StartTorqueMode); break;
        case MOTOR_CONTROLLER_BRAKE_MODE_VOLTAGE: MotorController_ForEachMotor(p_mc, Motor_User_StartVoltageMode); break;
        default: break;
    }
...
void MotorController_StartDriveZero(MotorController_T * p_mc)
{
    ...
    {
        case MOTOR_CONTROLLER_DRIVE_ZERO_MODE_FLOAT: MotorController_ForEachMotor(p_mc, Motor_User_Release); break;
        case MOTOR_CONTROLLER_DRIVE_ZERO_MODE_REGEN: /* MotorController_SetRegenMotorAll(p_mc); */ break;
        case MOTOR_CONTROLLER_DRIVE_ZERO_MODE_CRUISE: MotorController_ForEachMotor(p_mc, Motor_User_StartTorqueMode); break;
        default: break;
    }
}
