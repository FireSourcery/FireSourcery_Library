...
static inline void MotorController_User_SetCmdValue(MotorController_T * p_mc, int16_t userCmd) { _StateMachine_SetSyncInput(&p_mc->StateMachine, MCSM_INPUT_CMD, userCmd); }
