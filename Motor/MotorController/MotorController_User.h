...
//todo wrap analog monitor module
...
static inline uint16_t MotorController_User_GetVPosLimitUpper(MotorController_T * p_mc) 	{return p_mc->Parameters.VPosLimitUpper_ADCU;}
static inline uint16_t MotorController_User_GetVPosLimitLower(MotorController_T * p_mc) 	{return p_mc->Parameters.VPosLimitLower_ADCU;}

static inline void MotorController_User_SetVPosLimitUpper(MotorController_T * p_mc, uint16_t limit) {p_mc->Parameters.VPosLimitUpper_ADCU = limit;}
static inline void MotorController_User_SetVPosLimitLower(MotorController_T * p_mc, uint16_t limit) {p_mc->Parameters.VPosLimitLower_ADCU = limit;}
