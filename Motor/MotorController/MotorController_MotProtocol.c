...
const Protocol_Req_T MOTOR_CONTROLLER_MOT_PROTOCOL_REQ_TABLE[MOTOR_CONTROLLER_MOT_PROTOCOL_REQ_TABLE_LENGTH] =
{
    ...
    PROTOCOL_REQ(MOT_PACKET_VAR16_READ,       &MOT_FRAME_DATA,  Var16Read,           PROTOCOL_ACK_NONE),
    PROTOCOL_REQ(MOT_PACKET_VAR16_WRITE,      &MOT_FRAME_DATA,  Var16Write,          PROTOCOL_ACK_NONE),
    PROTOCOL_REQ(MOT_PACKET_VAR32_READ,       &MOT_FRAME_DATA,  ReadVar32,           PROTOCOL_ACK_NONE),
    PROTOCOL_REQ(MOT_PACKET_VAR32_WRITE,      &MOT_FRAME_DATA,  WriteVar32,          PROTOCOL_ACK_NONE),
    PROTOCOL_REQ(MOT_PACKET_FIXED_VAR_READ,   &MOT_FRAME_DATA,  ReadVar,             PROTOCOL_ACK_NONE),
    PROTOCOL_REQ(MOT_PACKET_FIXED_VAR_WRITE,  &MOT_FRAME_DATA,  WriteVar,            PROTOCOL_ACK_NONE),
    PROTOCOL_REQ(MOT_PACKET_MEM_READ,         &MOT_FRAME_DATA,  ReadMem_Blocking,    PROTOCOL_ACK_NONE),
    PROTOCOL_REQ(MOT_PACKET_MEM_WRITE,        &MOT_FRAME_DATA,  WriteMem_Blocking,   PROTOCOL_ACK_NONE),
#if defined(MOTOR_CONTROLLER_FLASH_LOADER_ENABLE)
    PROTOCOL_REQ(MOT_PACKET_DATA_MODE_READ,   &MOT_FRAME_DATA,  ReadData,            PROTOCOL_ACK_ON_REQ),
