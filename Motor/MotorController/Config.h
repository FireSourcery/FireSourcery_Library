...
#elif	defined(CONFIG_MOTOR_CONTROLLER_MANUFACTURE_PARAMS_RAM_COPY_DIABLE)
#else
	#define CONFIG_MOTOR_CONTROLLER_MANUFACTURE_PARAMS_RAM_COPY_ENABLE
#endif
...
#else
	#define CONFIG_MOTOR_CONTROLLER_FLASH_LOADER_ENABLE
#endif
