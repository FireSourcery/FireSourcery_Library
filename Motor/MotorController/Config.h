 ...
 * MemMap Config
 */
#ifdef  CONFIG_MEM_MAP_ONCE_ADDRESS
#else
	#error "Not defined: CONFIG_MEM_MAP_ONCE_ADDRESS"
#endif

#ifdef  CONFIG_MEM_MAP_ONCE_EXT_ADDRESS

#else
//	#error "Not defined: CONFIG_MEM_MAP_ONCE_EXT_ADDRESS"
#endif

#ifdef  CONFIG_MEM_MAP_READ_ONLY_ADDRESS
#else
	#error "Not defined: CONFIG_MEM_MAP_INFO_ADDRESS"
#endif

#ifdef  CONFIG_MEM_MAP_READ_WRITE_ADDRESS
#else
	#error "Not defined: CONFIG_MEM_MAP_READ_WRITE_ADDRESS"
#endif
