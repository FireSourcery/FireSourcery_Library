...
static int32_t _MotVarId_GetService(const MotorController_T * p_context, MotVarId_T id)
{
    switch ((MotVarId_Type_Service_T)id.NameType)
    {
        ...
        case MOT_VAR_ID_TYPE_ANALOG_USER_VAR_OUT: return AnalogUser_VarOutput_Get(p_context, id.NameBase, id.Instance);
        case MOT_VAR_ID_TYPE_ANALOG_USER_CONFIG: return AnalogUser_Config_Get(p_context, id.NameBase, id.Instance);
        case MOT_VAR_ID_TYPE_MONITOR_VAR_OUT: return _MotVarId_GetMonitorVar(p_context, id.NameBase, id.Instance);
        case MOT_VAR_ID_TYPE_V_MONITOR_SOURCE_CONFIG: return VMonitor_GetConfig(MotorController_User_GetPtrVMonitor(p_context, 0), id.NameBase);
        case MOT_VAR_ID_TYPE_V_MONITOR_AUX_CONFIG: return VMonitor_GetConfig(MotorController_User_GetPtrVMonitor(p_context, id.Instance + 1), id.NameBase);
        case MOT_VAR_ID_TYPE_HEAT_MONITOR_MOSFETS_CONFIG: return HeatMonitor_GetConfig(MotorController_User_GetPtrThermistor(p_context, id.Instance + 1), id.NameBase);
        case MOT_VAR_ID_TYPE_HEAT_MONITOR_PCB_CONFIG: return HeatMonitor_GetConfig(MotorController_User_GetPtrThermistor(p_context, 0), id.NameBase);
        case MOT_VAR_ID_TYPE_PROTOCOL_CONFIG: return Protocol_Config_Get(MotorController_User_GetPtrProtocol(p_context, id.Instance), id.NameBase);
        case MOT_VAR_ID_TYPE_BOOT_REF_CONFIG: return _MotVarId_GetBootRefConfig(p_context, id.NameBase);
        case MOT_VAR_ID_TYPE_BOARD_REF: return BoardRef_Get(p_context, id.NameBase);
...
static MotVarId_Status_T _MotVarId_SetService(const MotorController_T * p_context, MotVarId_T id, int32_t value)
{
    ...
    switch ((MotVarId_Type_Service_T)id.NameType)
    {
        ...
        case MOT_VAR_ID_TYPE_ANALOG_USER_CONFIG: AnalogUser_Config_Set(p_context, id.NameBase, id.Instance, value); return MOT_VAR_STATUS_OK;
        case MOT_VAR_ID_TYPE_MONITOR_VAR_OUT: return MOT_VAR_STATUS_ERROR_READ_ONLY;
        case MOT_VAR_ID_TYPE_V_MONITOR_SOURCE_CONFIG:
            p_vmonitor = MotorController_User_GetPtrVMonitor(p_context, 0);
            if (p_vmonitor == NULL) return MOT_VAR_STATUS_ERROR;
            VMonitor_SetConfig(p_vmonitor, id.NameBase, value); return MOT_VAR_STATUS_OK;
        case MOT_VAR_ID_TYPE_V_MONITOR_AUX_CONFIG:
            p_vmonitor = MotorController_User_GetPtrVMonitor(p_context, id.Instance + 1);
            if (p_vmonitor == NULL) return MOT_VAR_STATUS_ERROR;
            VMonitor_SetConfig(p_vmonitor, id.NameBase, value); return MOT_VAR_STATUS_OK;
        case MOT_VAR_ID_TYPE_HEAT_MONITOR_MOSFETS_CONFIG:
            p_thermistor = MotorController_User_GetPtrThermistor(p_context, id.Instance + 1);
            if (p_thermistor == NULL) return MOT_VAR_STATUS_ERROR;
            HeatMonitor_SetConfig(p_thermistor, id.NameBase, value); return MOT_VAR_STATUS_OK;
        case MOT_VAR_ID_TYPE_HEAT_MONITOR_PCB_CONFIG:
            p_thermistor = MotorController_User_GetPtrThermistor(p_context, 0);
            if (p_thermistor == NULL) return MOT_VAR_STATUS_ERROR;
            HeatMonitor_SetConfig(p_thermistor, id.NameBase, value); return MOT_VAR_STATUS_OK;
        case MOT_VAR_ID_TYPE_PROTOCOL_CONFIG: Protocol_Config_Set(MotorController_User_GetPtrProtocol(p_context, id.Instance), id.NameBase, value); return MOT_VAR_STATUS_OK;
...
{
    Motor_State_T * p_motor = MotorController_User_GetPtrMotor(p_context, id.Instance);
    ...
    switch ((MotVarId_Type_MotorVar_T)id.NameType)
    {
        ...
        case MOT_VAR_ID_TYPE_MOTOR_VAR_OUT_SENSOR: return Motor_VarOutput_PositionSensor_Get(p_motor, id.NameBase);
...
static MotVarId_Status_T _MotVarId_SetMotorVar(const MotorController_T * p_context, MotVarId_T id, int32_t value)
{
    ...
    switch ((MotVarId_Type_MotorVar_T)id.NameType)
    {
        ...
        case MOT_VAR_ID_TYPE_MOTOR_VAR_IO: Motor_VarIO_Set(p_motor, id.NameBase, value); return MOT_VAR_STATUS_OK;
        case MOT_VAR_ID_TYPE_MOTOR_VAR_CMD: Motor_VarInput_Set(p_motor, id.NameBase, value); return MOT_VAR_STATUS_OK;
...
static int32_t _MotVarId_GetMonitorVar(const MotorController_T * p_context, uint8_t nameBase, uint8_t instance)
{
    ...
    {
        // case MOT_MONITOR_V_SOURCE: return MotorController_Analog_GetVSource(p_context);
        // case MOT_MONITOR_V_ANALOG: return MotorController_Analog_GetVSense(p_context);
        // case MOT_MONITOR_V_ACCS: return MotorController_Analog_GetVAccs(p_context);
        // case MOT_MONITOR_HEAT_PCB: return MotHeatMonitor_Analog_GetHeatPcb(&p_context->MOT_HEAT_MONITOR_CONVERSIONS);
        // case MOT_MONITOR_HEAT_MOSFETS: return MotorController_Analog_GetHeatMosfets(p_context, instance);
        // case MOT_MONITOR_HEAT_MOSFETS_1: return MotorController_Analog_GetHeatMosfets(p_context, 1);
        // case MOT_MONITOR_HEAT_MOSFETS_2: return MotorController_Analog_GetHeatMosfets(p_context, 2);
        // case MOT_MONITOR_HEAT_MOSFETS_3: return MotorController_Analog_GetHeatMosfets(p_context, 3);
        default: return 0;
    }
}
...
static int32_t _MotVarId_GetDebug(const MotorController_T * p_context, uint8_t nameBase)
{
    ...
    switch ((MotorController_VarOutput_Debug_T)nameBase)
    {
        ...
        case MOT_VAR_DEBUG1: case MOT_VAR_DEBUG2: case MOT_VAR_DEBUG3:
        case MOT_VAR_DEBUG4: case MOT_VAR_DEBUG5: case MOT_VAR_DEBUG6: case MOT_VAR_DEBUG7: return 0;
        default: return 0;
    }
}
