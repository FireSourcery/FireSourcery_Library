...
uint8_t MotorController_Var_Set(MotorController_T * p_mc, MotVarId_T varId, int32_t varValue)
{
    ...
    switch(varId)
    {
        ...
        */
        ...
        case MOT_VAR_COMMUTATION_MODE:          Motor_User_GetCommutationMode(p_motor);         break;
        case MOT_VAR_SENSOR_MODE:               Motor_User_GetSensorMode(p_motor);              break;
        case MOT_VAR_DIRECTION_CALIBRATION:     Motor_User_GetDirectionCalibration(p_motor);    break;

        case MOT_VAR_POLE_PAIRS:                Motor_User_SetPolePairs(p_motor, varValue); 2U;    break;
        case MOT_VAR_KV:                        Motor_User_GetKv(p_motor);                      break;
        case MOT_VAR_SPEED_FEEDBACK_REF_RPM:    Motor_User_GetSpeedFeedbackRef_Rpm(p_motor);    break;
        case MOT_VAR_SPEED_V_REF_RPM:           Motor_User_GetSpeedVRef_Rpm(p_motor);           break;

        case MOT_VAR_I_REF_PEAK_ADCU:   GLOBAL_MOTOR.I_ZERO_TO_PEAK_ADCU;   break;
        case MOT_VAR_IA_REF_ZERO_ADCU:  Motor_User_GetIaZero_Adcu(p_motor); break;
        case MOT_VAR_IB_REF_ZERO_ADCU:  Motor_User_GetIbZero_Adcu(p_motor); break;
        case MOT_VAR_IC_REF_ZERO_ADCU:  Motor_User_GetIcZero_Adcu(p_motor); break;

        case MOT_VAR_BASE_SPEED_LIMIT_FORWARD_SCALAR16: Motor_User_GetSpeedLimitForward_ScalarU16(p_motor); break;
        case MOT_VAR_BASE_SPEED_LIMIT_REVERSE_SCALAR16: Motor_User_GetSpeedLimitReverse_ScalarU16(p_motor); break;
        case MOT_VAR_BASE_I_LIMIT_MOTORING_SCALAR16:    Motor_User_GetILimitMotoring_ScalarU16(p_motor);    break;
        case MOT_VAR_BASE_I_LIMIT_GENERATING_SCALAR16:  Motor_User_GetILimitGenerating_ScalarU16(p_motor);  break;

        case MOT_VAR_RAMP_ACCEL_TIME_CYCLES:            Motor_User_GetRampAccel_Cycles(p_motor); break;
        // case MOT_VAR_ALIGN_MODE:                        Motor_User_GetAlignMode(p_motor); break;
        case MOT_VAR_ALIGN_POWER_SCALAR16:              Motor_User_GetAlignPower_Scalar16(p_motor); break;
        case MOT_VAR_ALIGN_TIME_CYCLES:                 Motor_User_GetAlignTime_Cycles(p_motor); break;
        case MOT_VAR_OPEN_LOOP_POWER_SCALAR16:          Motor_User_GetOpenLoopPower_Scalar16(p_motor); break;
        case MOT_VAR_OPEN_LOOP_SPEED_SCALAR16:          Motor_User_GetOpenLoopSpeed_Scalar16(p_motor); break;
        case MOT_VAR_OPEN_LOOP_ACCEL_TIME_CYCLES:       Motor_User_GetOpenLoopAccel_Cycles(p_motor); break;
        // case MOT_VAR_PHASE_PWM_MODE:                    Motor_User_GetPhaseModeParam(p_motor); break;
        ...
        case MOT_VAR_IS_QUADRATURE_CAPTURE_ENABLED:     p_motor->Encoder.Params.IsQuadratureCaptureEnabled;     break;
        case MOT_VAR_IS_A_LEAD_B_POSITIVE:              p_motor->Encoder.Params.IsALeadBPositive;               break;
        // case MOT_VAR_ENCODER_EXTENDED_TIMER_DELTA_T_STOP:                            0; break;
        // case MOT_VAR_ENCODER_INTERPOLATE_ANGLE_SCALAR:                               0; break;

        case MOT_VAR_PID_SPEED_KP_FIXED_16:     PID_GetKp_Fixed16(&p_motor->PidSpeed);   break;
        case MOT_VAR_PID_SPEED_KI_FIXED_16:     PID_GetKi_Fixed16(&p_motor->PidSpeed);   break;
        // case MOT_VAR_PID_SPEED_KD_FIXED_16:  PID_GetKd_Fixed16(&p_motor->PidSpeed);   break;
        case MOT_VAR_PID_SPEED_SAMPLE_FREQ:     PID_GetSampleFreq(&p_motor->PidSpeed);  break;
        case MOT_VAR_PID_FOC_IQ_KP_FIXED_16:    PID_GetKp_Fixed16(&p_motor->PidIq);     break;
        case MOT_VAR_PID_FOC_IQ_KI_FIXED_16:    PID_GetKi_Fixed16(&p_motor->PidIq);     break;
        // case MOT_VAR_PID_FOC_IQ_KD_FIXED_16:    PID_GetKd_Fixed16(&p_motor->PidIq);  break;
        case MOT_VAR_PID_FOC_IQ_SAMPLE_FREQ:    PID_GetSampleFreq(&p_motor->PidIq);     break;
        case MOT_VAR_PID_FOC_ID_KP_FIXED_16:    PID_GetKp_Fixed16(&p_motor->PidId);     break;
        case MOT_VAR_PID_FOC_ID_KI_FIXED_16:    PID_GetKi_Fixed16(&p_motor->PidId);     break;
        // case MOT_VAR_PID_FOC_ID_KD_FIXED_16:    PID_GetKd_Fixed16(&p_motor->PidId);  break;
        case MOT_VAR_PID_FOC_ID_SAMPLE_FREQ:    PID_GetSampleFreq(&p_motor->PidId);     break;

        case MOT_VAR_THERMISTOR_MOTOR_LINEAR_T0_ADCU:           Thermistor_GetLinearT0_Adcu(&p_motor->Thermistor);          break;
        case MOT_VAR_THERMISTOR_MOTOR_LINEAR_T0_DEG_C:          Thermistor_GetLinearT0_DegC(&p_motor->Thermistor);          break;
        case MOT_VAR_THERMISTOR_MOTOR_LINEAR_T1_ADCU:           Thermistor_GetLinearT1_Adcu(&p_motor->Thermistor);          break;
        case MOT_VAR_THERMISTOR_MOTOR_LINEAR_T1_DEG_C:          Thermistor_GetLinearT1_DegC(&p_motor->Thermistor);          break;
        case MOT_VAR_THERMISTOR_MOTOR_TYPE:                     Thermistor_GetType(&p_motor->Thermistor);          break;
        case MOT_VAR_THERMISTOR_MOTOR_R:                        Thermistor_GetR0(&p_motor->Thermistor);                     break;
        case MOT_VAR_THERMISTOR_MOTOR_T:                        Thermistor_GetT0(&p_motor->Thermistor);                     break;
        case MOT_VAR_THERMISTOR_MOTOR_B:                        Thermistor_GetB(&p_motor->Thermistor);                      break;
        case MOT_VAR_THERMISTOR_MOTOR_FAULT_ADCU:               Thermistor_GetShutdown_Adcu(&p_motor->Thermistor);          break;
        case MOT_VAR_THERMISTOR_MOTOR_FAULT_THRESHOLD_ADCU:     Thermistor_GetShutdownThreshold_Adcu(&p_motor->Thermistor); break;
        case MOT_VAR_THERMISTOR_MOTOR_WARNING_ADCU:             Thermistor_GetWarning_Adcu(&p_motor->Thermistor);           break;
        case MOT_VAR_THERMISTOR_MOTOR_WARNING_THRESHOLD_ADCU:   Thermistor_GetWarningThreshold_Adcu(&p_motor->Thermistor);  break;
        case MOT_VAR_THERMISTOR_MOTOR_IS_MONITOR_ENABLE:        Thermistor_GetIsMonitorEnable(&p_motor->Thermistor);        break;

        case MOT_VAR_V_SOURCE_VOLTS:                            MotorController_User_GetVSourceRef(p_mc);   break;
        ...
        case MOT_VAR_OPT_DIN_SPEED_LIMIT_SCALAR16:              (p_mc->Parameters.OptDinSpeedLimit_Scalar16);   break;
        case MOT_VAR_I_LIMIT_LOW_V_SCALAR16:                    (p_mc->Parameters.ILimitLowV_Scalar16);         break;
        ...
        case MOT_VAR_VMONITOR_SOURCE_LIMIT_UPPER_ADCU:          VMonitor_GetLimitUpper(&p_mc->VMonitorSource);      break;
        case MOT_VAR_VMONITOR_SOURCE_LIMIT_LOWER_ADCU:          VMonitor_GetLimitLower(&p_mc->VMonitorSource);      break;
        case MOT_VAR_VMONITOR_SOURCE_WARNING_UPPER_ADCU:        VMonitor_GetWarningUpper(&p_mc->VMonitorSource);    break;
        case MOT_VAR_VMONITOR_SOURCE_WARNING_LOWER_ADCU:        VMonitor_GetWarningLower(&p_mc->VMonitorSource);    break;
        case MOT_VAR_VMONITOR_SOURCE_IS_ENABLE:                 VMonitor_GetIsEnable(&p_mc->VMonitorSource);        break;
        case MOT_VAR_VMONITOR_SENSE_LIMIT_UPPER_ADCU:           VMonitor_GetLimitUpper(&p_mc->VMonitorSense);      break;
        case MOT_VAR_VMONITOR_SENSE_LIMIT_LOWER_ADCU:           VMonitor_GetLimitLower(&p_mc->VMonitorSense);      break;
        case MOT_VAR_VMONITOR_SENSE_WARNING_UPPER_ADCU:         VMonitor_GetWarningUpper(&p_mc->VMonitorSense);    break;
        case MOT_VAR_VMONITOR_SENSE_WARNING_LOWER_ADCU:         VMonitor_GetWarningLower(&p_mc->VMonitorSense);    break;
        case MOT_VAR_VMONITOR_SENSE_IS_ENABLE:                  VMonitor_GetIsEnable(&p_mc->VMonitorSense);        break;
        case MOT_VAR_VMONITOR_ACC_LIMIT_UPPER_ADCU:             VMonitor_GetLimitUpper(&p_mc->VMonitorAcc);      break;
        case MOT_VAR_VMONITOR_ACC_LIMIT_LOWER_ADCU:             VMonitor_GetLimitLower(&p_mc->VMonitorAcc);      break;
        case MOT_VAR_VMONITOR_ACC_WARNING_UPPER_ADCU:           VMonitor_GetWarningUpper(&p_mc->VMonitorAcc);    break;
        case MOT_VAR_VMONITOR_ACC_WARNING_LOWER_ADCU:           VMonitor_GetWarningLower(&p_mc->VMonitorAcc);    break;
        case MOT_VAR_VMONITOR_ACC_IS_ENABLE:                    VMonitor_GetIsEnable(&p_mc->VMonitorAcc);        break;
        case MOT_VAR_THERMISTOR_PCB_TYPE:                       Thermistor_GetLinearT0_Adcu(&p_mc->ThermistorPcb);          break;
        case MOT_VAR_THERMISTOR_PCB_R:                          Thermistor_GetLinearT0_DegC(&p_mc->ThermistorPcb);          break;
        case MOT_VAR_THERMISTOR_PCB_T:                          Thermistor_GetLinearT1_Adcu(&p_mc->ThermistorPcb);          break;
        case MOT_VAR_THERMISTOR_PCB_B:                          Thermistor_GetLinearT1_DegC(&p_mc->ThermistorPcb);          break;
        case MOT_VAR_THERMISTOR_PCB_LINEAR_T0_ADCU:             Thermistor_GetType(&p_mc->ThermistorPcb);          break;
        case MOT_VAR_THERMISTOR_PCB_LINEAR_T0_DEG_C:            Thermistor_GetR0(&p_mc->ThermistorPcb);                     break;
        case MOT_VAR_THERMISTOR_PCB_LINEAR_T1_ADCU:             Thermistor_GetT0(&p_mc->ThermistorPcb);                     break;
        case MOT_VAR_THERMISTOR_PCB_LINEAR_T1_DEG_C:            Thermistor_GetB(&p_mc->ThermistorPcb);                      break;
        case MOT_VAR_THERMISTOR_PCB_FAULT_ADCU:                 Thermistor_GetShutdown_Adcu(&p_mc->ThermistorPcb);          break;
        case MOT_VAR_THERMISTOR_PCB_FAULT_THRESHOLD_ADCU:       Thermistor_GetShutdownThreshold_Adcu(&p_mc->ThermistorPcb); break;
        case MOT_VAR_THERMISTOR_PCB_WARNING_ADCU:               Thermistor_GetWarning_Adcu(&p_mc->ThermistorPcb);           break;
        case MOT_VAR_THERMISTOR_PCB_WARNING_THRESHOLD_ADCU:     Thermistor_GetWarningThreshold_Adcu(&p_mc->ThermistorPcb);  break;
        case MOT_VAR_THERMISTOR_PCB_IS_MONITOR_ENABLE:          Thermistor_GetIsMonitorEnable(&p_mc->ThermistorPcb);        break;
        case MOT_VAR_THERMISTOR_MOSFETS_TYPE:                   Thermistor_GetLinearT0_Adcu(&p_mc->ThermistorMosfets);          break;
        case MOT_VAR_THERMISTOR_MOSFETS_R:                      Thermistor_GetLinearT0_DegC(&p_mc->ThermistorMosfets);          break;
        case MOT_VAR_THERMISTOR_MOSFETS_T:                      Thermistor_GetLinearT1_Adcu(&p_mc->ThermistorMosfets);          break;
        case MOT_VAR_THERMISTOR_MOSFETS_B:                      Thermistor_GetLinearT1_DegC(&p_mc->ThermistorMosfets);          break;
        case MOT_VAR_THERMISTOR_MOSFETS_LINEAR_T0_ADCU:         Thermistor_GetType(&p_mc->ThermistorMosfets);          break;
        case MOT_VAR_THERMISTOR_MOSFETS_LINEAR_T0_DEG_C:        Thermistor_GetR0(&p_mc->ThermistorMosfets);                     break;
        case MOT_VAR_THERMISTOR_MOSFETS_LINEAR_T1_ADCU:         Thermistor_GetT0(&p_mc->ThermistorMosfets);                     break;
        case MOT_VAR_THERMISTOR_MOSFETS_LINEAR_T1_DEG_C:        Thermistor_GetB(&p_mc->ThermistorMosfets);                      break;
        case MOT_VAR_THERMISTOR_MOSFETS_FAULT_ADCU:             Thermistor_GetShutdown_Adcu(&p_mc->ThermistorMosfets);          break;
        case MOT_VAR_THERMISTOR_MOSFETS_FAULT_THRESHOLD_ADCU:   Thermistor_GetShutdownThreshold_Adcu(&p_mc->ThermistorMosfets); break;
        case MOT_VAR_THERMISTOR_MOSFETS_WARNING_ADCU:           Thermistor_GetWarning_Adcu(&p_mc->ThermistorMosfets);           break;
        case MOT_VAR_THERMISTOR_MOSFETS_WARNING_THRESHOLD_ADCU: Thermistor_GetWarningThreshold_Adcu(&p_mc->ThermistorMosfets);  break;
        case MOT_VAR_THERMISTOR_MOSFETS_IS_MONITOR_ENABLE:      Thermistor_GetIsMonitorEnable(&p_mc->ThermistorMosfets);        break;
        ...
        case MOT_VAR_ANALOG_DIN_BRAKE_VALUE_FRAC16:             p_mc->AnalogUser.Params.BistateBrakeValue_Frac16; break;
        ...
        case MOT_VAR_PROTOCOL0_XCVR_ID:                         MotorController_User_GetPtrProtocol(p_mc, 0)->Params.SpecsId; break;
