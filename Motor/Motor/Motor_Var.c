...
int _Motor_Var_AngleSpeed_Get(const Motor_State_T * p_motor, Motor_Var_AngleSpeed_T varId)
{
    switch (varId)
    {
...
*/
void _Motor_VarConfigCmd_Call(const Motor_T * p_motor, Motor_VarConfigCmd_T varId, int varValue)
{
    switch (varId)
    {
...
*/
/* SensorCapture */
// int _Motor_Var_AngleSpeed_Get(const Motor_State_T * p_motor, Motor_Var_AngleSpeed_T varId) { return Motor_Var_AngleSpeed_Get(p_motor->p_ActiveSensor, varId); }
...
void Motor_Var_PidTuning_Set(const Motor_T * p_motor, Motor_VarConfig_Pid_T varId, int varValue) { VarAccess_SetAt(&p_motor->VAR_ACCESS.ACCESS_PID_TUNING, varId, varValue); }
void Motor_Var_UserControl_Set(const Motor_T * p_motor, Motor_Var_UserControl_T varId, int varValue) { VarAccess_SetAt(&p_motor->VAR_ACCESS.ACCESS_USER_CONTROL, varId, varValue); }
void Motor_Var_StateCmd_Set(const Motor_T * p_motor, Motor_Var_StateCmd_T varId, int varValue) { VarAccess_SetAt(&p_motor->VAR_ACCESS.ACCESS_STATE_CMD, varId, varValue); }
...
static int Var_Sensor_Get(const Motor_State_T * p_motor, int varId) { return _Motor_Var_AngleSpeed_Get(p_motor, varId); }
...
int Motor_VarType_Get(const Motor_T * p_motor, Motor_VarType_T typeId, int varId)
{
    ...
    switch (typeId)
    {
        ...
        case MOTOR_VAR_TYPE_SPEED_ANGLE_OUT:    return _Motor_Var_AngleSpeed_Get(p_motor->P_MOTOR_STATE, varId);
...
void Motor_VarType_Set(const Motor_T * p_motor, Motor_VarType_T typeId, int varId, int varValue)
{
    ...
    switch (typeId)
    {
        ...
        case MOTOR_VAR_TYPE_SPEED_ANGLE_OUT:     break;
