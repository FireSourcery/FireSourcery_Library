...
int32_t _Motor_VarIO_Get(const Motor_T * p_motor, Motor_VarIO_T varId)
{
    int32_t value = 0;
    switch (varId)
    {
...
int Motor_VarIO_Get(const Motor_T * p_motor, int varId) { return _Motor_VarIO_Get(p_motor, varId); }
