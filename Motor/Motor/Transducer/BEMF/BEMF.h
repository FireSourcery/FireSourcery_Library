...
typedef struct
{
	//	const HAL_uint16_t * p_HAL_Bemf; //hw timer version
	//	uin32_t TimerFreq;
...
//		case BEMF_SAMPLE_MODE_PWM_MIXED: 			break;
		case BEMF_SAMPLE_MODE_PWM_ON: 		vZero = ((int32_t)p_bemf->VPos_ADCU / 2U) + (int32_t)p_bemf->ZeroCrossingThreshold_ADCU; break;
