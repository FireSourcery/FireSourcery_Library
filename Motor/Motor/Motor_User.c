...
*/
int32_t _Motor_User_CalcDirectionalCmd(Motor_T * p_motor, int16_t userCmd)
{
...
*/
void Motor_User_SetSpeedCmdValue(Motor_T * p_motor, int16_t speed)
{
...
void Motor_SetOpenLoopMagnitude(Motor_T * p_motor, int32_t qMagnitude)
{
