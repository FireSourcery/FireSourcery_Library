...
{
    _Motor_User_SetTorqueCmd(p_motor, math_clamp(volts_fract16, 0, MotorAnalog_GetVSource_Fract16() / 2));
}
...
{
    Motor_User_SetSpeedCmd(p_motor, fract16_mul(p_motor->Config.SpeedLimitForward_Fract16, scalar_fract16));
}
