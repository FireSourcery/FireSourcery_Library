...
{
	// return !math_isbound(p_motor->Speed_Frac16 / 2, 0 - ((int32_t)p_motor->SpeedLimitCw_FracS16 * 7 / 8), (int32_t)p_motor->SpeedLimitCcw_FracS16 * 7 / 8);
}
