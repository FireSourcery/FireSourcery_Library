...
typedef struct Motor_Tag
{
	...
	*/
	...
	int32_t SpeedFeedback_Frac16; 		/* [-65535:65535] Speed Feedback Variable. Can over saturate */
...
// extern bool Motor_CheckFeedbackMode(Motor_T * p_motor, Motor_FeedbackMode_T mode);
