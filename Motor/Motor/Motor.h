...
*/
static inline int32_t Motor_ConvertUserDirection(const Motor_T * p_motor, int32_t userCmd)
{
...
extern void Motor_InitActiveLimits(Motor_T * p_motor);
