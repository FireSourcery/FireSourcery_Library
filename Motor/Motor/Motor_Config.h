...
{
    MOTOR_VAR_PID_SPEED_KP,
    MOTOR_VAR_PID_SPEED_KI,
    MOTOR_VAR_PID_SPEED_KD,
    MOTOR_VAR_PID_SPEED_SAMPLE_FREQ,
    MOTOR_VAR_PID_CURRENT_KP,
    MOTOR_VAR_PID_CURRENT_KI,
    MOTOR_VAR_PID_CURRENT_KD,
