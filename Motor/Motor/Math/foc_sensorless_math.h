...
{
    return fract16_sat((accum32_t)vd - fract16_mul(Rs_pu, id) - foc_vd_ff(iq, omega_Lq_pu));
}
...
{
    return fract16_sat((accum32_t)vq - fract16_mul(Rs_pu, iq) - foc_vq_ff(id, omega_Ld_pu, omega_psi_pu));
}
