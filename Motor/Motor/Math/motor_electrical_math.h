...
// static inline uint32_t psi_uwb_of_emf_ll(uint32_t omega_rads, uint32_t v_ll_mV_pk) { return (uint64_t)v_ll_mV_pk * 1000000UL * FRACT16_SCALE / ((uint64_t)FRACT16_SQRT3 * omega_rads); }
