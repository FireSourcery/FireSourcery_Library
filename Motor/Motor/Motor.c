...
void Motor_Init(Motor_T * p_dev)
{
    ...
    */
    ...
    // FOC_Init(&p_dev->P_MOTOR->Foc, &p_dev->P_FOC_NVM_CONFIG);
...
{
    Ramp_Init(&p_motor->SpeedRamp, p_motor->Config.SpeedRampTime_Cycles, _Motor_SpeedRated_Fract16(&p_motor->Config.SpeedRating));
