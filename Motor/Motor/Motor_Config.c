...
*/
void Motor_Config_SetSpeedLimitForward_Scalar16(MotorPtr_T p_motor, uint16_t forward_Frac16)
{
...
void Motor_Config_SetSpeedLimitReverse_Scalar16(MotorPtr_T p_motor, uint16_t reverse_Frac16)
{
...
void Motor_Config_SetSpeedLimit_Scalar16(MotorPtr_T p_motor, uint16_t forwardScalar16, uint16_t reverseScalar16)
{
...
/*
    Persistent ILimit
*/
void Motor_Config_SetILimitMotoring_Scalar16(MotorPtr_T p_motor, uint16_t motoring_Frac16)
{
    p_motor->Config.ILimitMotoring_Scalar16 = motoring_Frac16;
    PropagateSet(p_motor, Motor_ResetILimitActive);
}

void Motor_Config_SetILimitGenerating_Scalar16(MotorPtr_T p_motor, uint16_t generating_Frac16)
{
    p_motor->Config.ILimitGenerating_Scalar16 = generating_Frac16;
    PropagateSet(p_motor, Motor_ResetILimitActive);
}

void Motor_Config_SetILimit_Scalar16(MotorPtr_T p_motor, uint16_t motoring_Frac16, uint16_t generating_Frac16)
{
    p_motor->Config.ILimitMotoring_Scalar16 = motoring_Frac16;
    p_motor->Config.ILimitGenerating_Scalar16 = generating_Frac16;
    PropagateSet(p_motor, Motor_ResetILimitActive);
...
void Motor_Config_SetSpeedLimit_Rpm(MotorPtr_T p_motor, uint16_t forward_Rpm, uint16_t reverse_Rpm)
{
...
void Motor_Config_SetSpeedLimitForward_Rpm(MotorPtr_T p_motor, uint16_t forward_Rpm)
{
    Motor_Config_SetSpeedLimitForward_Scalar16(p_motor, ConvertToSpeedLimitScalar16(p_motor, forward_Rpm));
}

void Motor_Config_SetSpeedLimitReverse_Rpm(MotorPtr_T p_motor, uint16_t reverse_Rpm)
{
    Motor_Config_SetSpeedLimitReverse_Scalar16(p_motor, ConvertToSpeedLimitScalar16(p_motor, reverse_Rpm));
}

uint16_t Motor_Config_GetSpeedLimitForward_Rpm(MotorPtr_T p_motor)
{
...
uint16_t Motor_Config_GetSpeedLimitReverse_Rpm(MotorPtr_T p_motor)
{
...
void Motor_Config_SetILimit_Amp(MotorPtr_T p_motor, uint16_t motoring_Amp, uint16_t generating_Amp)
{
...
void Motor_Config_SetILimitMotoring_Amp(MotorPtr_T p_motor, uint16_t motoring_Amp)
{
    Motor_Config_SetILimitMotoring_Scalar16(p_motor, ConvertToILimitScalar16(p_motor, motoring_Amp));
}

void Motor_Config_SetILimitGenerating_Amp(MotorPtr_T p_motor, uint16_t generating_Amp)
{
    Motor_Config_SetILimitGenerating_Scalar16(p_motor, ConvertToILimitScalar16(p_motor, generating_Amp));
}

uint16_t Motor_Config_GetILimitMotoring_Amp(MotorPtr_T p_motor) { return _Motor_ConvertI_Scalar16ToAmp(p_motor->Config.ILimitMotoring_Scalar16); }
uint16_t Motor_Config_GetILimitGenerating_Amp(MotorPtr_T p_motor) { return _Motor_ConvertI_Scalar16ToAmp(p_motor->Config.ILimitGenerating_Scalar16); }
#endif
...
void Motor_Config_SetSpeedFeedbackRef_Rpm(MotorPtr_T p_motor, uint16_t rpm)
{
...
void Motor_Config_SetSpeedVRef_Rpm(MotorPtr_T p_motor, uint16_t rpm)
{
...
static void SetSpeedFeedbackRef_Kv(MotorPtr_T p_motor, uint16_t kv) { Motor_Config_SetSpeedFeedbackRef_Rpm(p_motor, kv * Motor_Static_GetVSource_V()); }
static void SetVSpeedRef_Kv(MotorPtr_T p_motor, uint16_t kv) { Motor_Config_SetSpeedVRef_Rpm(p_motor, kv * Motor_Static_GetVSource_V()); }

/* Setting Kv overwrites SpeedFeedbackRef. SpeedFeedbackRef can be set independently from Kv */
void Motor_Config_SetKv(MotorPtr_T p_motor, uint16_t kv)
{
...
void Motor_Config_SetIaZero_Adcu(MotorPtr_T p_motor, uint16_t adcu) { p_motor->Config.IaZeroRef_Adcu = adcu; PropagateSet(p_motor, Motor_ResetUnitsIa); }
void Motor_Config_SetIbZero_Adcu(MotorPtr_T p_motor, uint16_t adcu) { p_motor->Config.IbZeroRef_Adcu = adcu; PropagateSet(p_motor, Motor_ResetUnitsIb); }
void Motor_Config_SetIcZero_Adcu(MotorPtr_T p_motor, uint16_t adcu) { p_motor->Config.IcZeroRef_Adcu = adcu; PropagateSet(p_motor, Motor_ResetUnitsIc); }

void Motor_Config_SetDirectionCalibration(MotorPtr_T p_motor, Motor_Direction_T directionForward)
{
    p_motor->Config.DirectionForward = directionForward;
    PropagateSet(p_motor, Motor_SetDirectionForward);
}

void Motor_Config_SetPolePairs(MotorPtr_T p_motor, uint8_t polePairs) { p_motor->Config.PolePairs = polePairs; PropagateSet(p_motor, Motor_ResetUnitsSensor); }

/* Reboot unless deinit is implemented in HAL */
void Motor_Config_SetSensorMode(MotorPtr_T p_motor, Motor_SensorMode_T mode) { p_motor->Config.SensorMode = mode; PropagateSet(p_motor, Motor_InitSensor); }

/******************************************************************************/
/* IPeak  */
/******************************************************************************/
void Motor_Config_SetIPeakRef_Adcu(MotorPtr_T p_motor, uint16_t adcu)
{
...
void Motor_Config_SetIPeakRef_MilliV(MotorPtr_T p_motor, uint16_t min_MilliV, uint16_t max_MilliV)
{
