...
*/
/******************************************************************************/
static inline void Motor_Analog_OnCompleteA(Motor_T * p_motor, uint16_t adcu) { p_motor->PhaseFlags.A = 1U; }
static inline void Motor_Analog_OnCompleteB(Motor_T * p_motor, uint16_t adcu) { p_motor->PhaseFlags.B = 1U; }
static inline void Motor_Analog_OnCompleteC(Motor_T * p_motor, uint16_t adcu) { p_motor->PhaseFlags.C = 1U; }
...
#define MOTOR_ANALOG_CONVERSION_VA_INIT(ChannelBase, VaHost, VaPin, p_Motor) ANALOG_CONVERSION_INIT((ChannelBase + MOTOR_ANALOG_CHANNEL_VA), (Analog_Setter_T)Motor_Analog_OnCompleteA, p_Motor, VaHost, VaPin)
#define MOTOR_ANALOG_CONVERSION_VB_INIT(ChannelBase, VbHost, VbPin, p_Motor) ANALOG_CONVERSION_INIT((ChannelBase + MOTOR_ANALOG_CHANNEL_VB), (Analog_Setter_T)Motor_Analog_OnCompleteB, p_Motor, VbHost, VbPin)
#define MOTOR_ANALOG_CONVERSION_VC_INIT(ChannelBase, VcHost, VcPin, p_Motor) ANALOG_CONVERSION_INIT((ChannelBase + MOTOR_ANALOG_CHANNEL_VC), (Analog_Setter_T)Motor_Analog_OnCompleteC, p_Motor, VcHost, VcPin)
#define MOTOR_ANALOG_CONVERSION_IA_INIT(ChannelBase, IaHost, IaPin, p_Motor) ANALOG_CONVERSION_INIT((ChannelBase + MOTOR_ANALOG_CHANNEL_IA), (Analog_Setter_T)Motor_Analog_OnCompleteA, p_Motor, IaHost, IaPin)
#define MOTOR_ANALOG_CONVERSION_IB_INIT(ChannelBase, IbHost, IbPin, p_Motor) ANALOG_CONVERSION_INIT((ChannelBase + MOTOR_ANALOG_CHANNEL_IB), (Analog_Setter_T)Motor_Analog_OnCompleteB, p_Motor, IbHost, IbPin)
#define MOTOR_ANALOG_CONVERSION_IC_INIT(ChannelBase, IcHost, IcPin, p_Motor) ANALOG_CONVERSION_INIT((ChannelBase + MOTOR_ANALOG_CHANNEL_IC), (Analog_Setter_T)Motor_Analog_OnCompleteC, p_Motor, IcHost, IcPin)
