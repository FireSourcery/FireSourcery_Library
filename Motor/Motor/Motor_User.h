...
extern void Motor_User_Hold(MotorPtr_T p_motor);
extern bool Motor_User_SetDirection(MotorPtr_T p_motor, Motor_Direction_T direction);
extern bool Motor_User_SetDirectionForward(MotorPtr_T p_motor);
extern bool Motor_User_SetDirectionReverse(MotorPtr_T p_motor);
