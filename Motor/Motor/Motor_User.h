...
static inline int16_t Motor_User_GetSpeed_DegPerCycle(const Motor_State_T * p_motor) { return Motor_DirectionalValueOf(p_motor, MotorSensor_GetElectricalAngleSpeed(p_motor->p_ActiveSensor->P_STATE)); }
