...
// MotPacket_VarReadResp_Payload_T * MotPacket_VarReadReqOf(uint8_t * p_reqPacket) { return (MotPacket_VarReadResp_Payload_T *)p_reqPacket; }
...
{
    p_respPacket->Header.Flags = status;
