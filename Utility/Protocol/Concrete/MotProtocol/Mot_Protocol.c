...
static void BuildTxSync(MotProtocol_SyncPacket_T * p_txPacket, size_t * p_txSize, Protocol_TxSyncId_T txId)
{
	...
	switch(txId)
	{
		...
		default: *p_txSize = 0U; syncId = 0U; break;
	}
...
/*
	...
	MotProtocol_HeaderId_T is cast to uint8_t
*/
static const Protocol_Req_T CMDR_REQ_TABLE[] =
{
	PROTOCOL_REQ_DEFINE(MOTPROTOCOL_CMD_MONITOR_TYPE, 	MotProtocol_ReqPacket_Monitor_Build,  	PROTOCOL_SYNC_ID_DISABLE),
	PROTOCOL_REQ_DEFINE(MOTPROTOCOL_CMD_CONTROL_TYPE, 	MotProtocol_ReqPacket_Control_Build, 	PROTOCOL_SYNC_ID_DISABLE),
};
