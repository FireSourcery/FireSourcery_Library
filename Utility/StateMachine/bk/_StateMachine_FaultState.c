...
void StateMachine_SetFault(StateMachine_T * p_stateMachine, state_input_value_t faultFlags)
{
...
void StateMachine_ClearFault(StateMachine_T * p_stateMachine, state_input_value_t faultFlags)
{
