...
/******************************************************************************/
/* Internal use */
typedef State_T * (*_StateMachine_TransitionFunction_T)(State_T * p_state, void * p_context, state_input_t inputId, state_value_t inputValue);
...
static inline void __StateMachine_ProcSyncInput(
    ...
    State_T * p_state,
    void * p_context,
    StateMachine_SyncInput_T * p_syncInputs,
