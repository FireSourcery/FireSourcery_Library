...
void StateMachine_SetFault(StateMachine_T * p_stateMachine, state_machine_value_t faultFlags)
{
    // *(state_machine_value_t *)p_stateMachine->P_STATE_CONTEXT |= faultFlags;
...
bool StateMachine_ClearFault(StateMachine_T * p_stateMachine, state_machine_value_t faultFlags)
{
