...
//     #define _STATE_MACHINE_LINKED(code, ...) code
// #else
//     #define _STATE_MACHINE_LINKED(code, ...) (void)(__VA_ARGS__)
// #endif

// State_T * Next(State_T * p_state) _STATE_MACHINE_LINKED
// {
//     return p_state->P_NEXT_MENU;
// }
...
// {
//     _StateMachine_TransitionTo(p_stateMachine, p_targetMenu);
// }
